...
echo ""
echo "  2. Configure MGMT IPs manually via VM console"
echo "     See: MGMT-IP-MANUAL-CONFIG.md"
echo "     (~1 minute per VM, copy-paste commands)"
echo ""
echo "  3. Verify MGMT IPs from Proxmox host:"
echo "     ping 10.0.0.50  # juri-srv"
echo "     ping 10.0.0.10  # int-srv"
echo ""
echo "  4. SSH to juri-srv:"
...
echo ""
echo -e "${CYAN}📝 See MGMT-IP-MANUAL-CONFIG.md for detailed commands${NC}"
echo ""
